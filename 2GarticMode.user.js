...
window.gg.cst = {
    drawing: {
        ...
        customPalette: localStorage.customPalette ? JSON.parse(localStorage.customPalette) : ["#000000"],
    }
};
...
function createCustomPaletteModule(){
    ...
    }), extendColorInput = dynamElem("input", {
        className: "custom-palette-plus-button",
        type: "color",
        style:"opacity:0;width:100%;height:100%;position:relative;top:-29px;left:-2px;",
        onchange: function(e){
            var colorBox = dynamElem("div", {
    ...
    colorList.firstChild.insertAdjacentElement("beforeBegin", plusButton);
    return palette;
}
